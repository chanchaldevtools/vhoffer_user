...
const WhatsAppIcon = ({ color = "#25D366", size = 20 }) => (
...
const ProfileScreen = () => {
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={[styles.scrollContainer, { paddingBottom: Math.max(insets.bottom, 16) + 64 }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuContainer}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={styles.iconWrapper}><PaymentIcon /></View>
  ...
  <View style={styles.channelHeader}>
    <Text style={styles.channelTitle}>Corporate Communication Channels</Text>
  </View>

  {/* Dispatch & Bookings */}
  <TouchableOpacity 
    style={styles.contactItem} 
    onPress={() => Linking.openURL('mailto:firstclassbooking24@gmail.com')}
  >
    <View style={styles.iconWrapper}>
      <EmailIcon color="#E67E22" size={18} />
    </View>
    <View style={styles.contactTextContainer}>
      <Text style={styles.contactLabel}>• Dispatch & Bookings</Text>
      <Text style={styles.contactValue}>firstclassbooking24@gmail.com</Text>
    </View>
  </TouchableOpacity>
  ...
  <TouchableOpacity 
    style={styles.contactItem} 
    onPress={() => Linking.openURL('mailto:firstclasstravelusallc@gmail.com')}
  >
    <View style={styles.iconWrapper}>
      <EmailIcon color="#E67E22" size={18} />
    </View>
    <View style={styles.contactTextContainer}>
      <Text style={styles.contactLabel}>• Contract Inquiries</Text>
      <Text style={styles.contactValue}>firstclasstravelusallc@gmail.com</Text>
    </View>
  </TouchableOpacity>
  ...
  <TouchableOpacity 
    style={styles.contactItem} 
    onPress={() => Linking.openURL('mailto:fctusabilling@gmail.com')}
  >
    <View style={styles.iconWrapper}>
      <EmailIcon color="#E67E22" size={18} />
    </View>
    <View style={styles.contactTextContainer}>
      <Text style={styles.contactLabel}>• Billing & Invoicing</Text>
      <Text style={styles.contactValue}>fctusabilling@gmail.com</Text>
    </View>
  </TouchableOpacity>

  {/* Direct Lines Header */}
  <View style={styles.directLinesHeader}>
    <Text style={styles.directLinesTitle}>Direct Lines</Text>
  </View>

  {/* Executive Administration - With Call and WhatsApp */}
  <View style={styles.contactItem}>
    <View style={styles.iconWrapper}>
      <PhoneIcon color="#E67E22" size={18} />
    </View>
    <View style={styles.contactTextContainer}>
      <Text style={styles.contactLabel}>• Executive Administration (CEO Direct Line & WhatsApp)</Text>
      <Text style={styles.contactValue}>+1 (929) 354‑3882</Text>
      <View style={styles.actionButtonsRow}>
        <TouchableOpacity 
          style={[styles.actionButton, styles.callButton]}
          onPress={() => Linking.openURL('tel:+19293543882')}
        >
        ...
        <TouchableOpacity 
          ...
          onPress={() => Linking.openURL('whatsapp://send?phone=+19293543882')}
        >
          <WhatsAppIcon color="#FFFFFF" size={14} />
  ...
  {/* Operations & Dispatch - With Call and WhatsApp */}
  <View style={[styles.contactItem, styles.noBorder]}>
    <View style={styles.iconWrapper}>
      <PhoneIcon color="#E67E22" size={18} />
    </View>
    <View style={styles.contactTextContainer}>
      <Text style={styles.contactLabel}>• Operations & Dispatch (Cell & WhatsApp)</Text>
      <Text style={styles.contactValue}>+1 (929) 769‑1717</Text>
      <View style={styles.actionButtonsRow}>
        <TouchableOpacity 
          style={[styles.actionButton, styles.callButton]}
          onPress={() => Linking.openURL('tel:+19297691717')}
        >
          <PhoneIcon color="#FFFFFF" size={14} />
          <Text style={styles.actionButtonText}>Call</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.actionButton, styles.whatsappButton]}
          onPress={() => Linking.openURL('whatsapp://send?phone=+19297691717')}
        >
          <WhatsAppIcon color="#FFFFFF" size={14} />
          <Text style={styles.actionButtonText}>WhatsApp</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  menuContainer: { backgroundColor: '#1C1C1E', borderRadius: 16, borderWidth: 0.5, borderColor: '#2C2C2E', marginBottom: 44, overflow: 'hidden' },
  ...
  contactContainer: { marginVertical: 0 },
  contactItem: { gap: 16, paddingVertical: 16, borderBottomWidth: 0.5, borderColor: '#2C2C2E' },
